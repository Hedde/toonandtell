...
- **Fingerprint-in-de-loop: oppervlakte werkt niet, vorm wél.** Komma's mechanisch fixen of functiewoorden surgisch bijstellen laat de vingerafdruk onbewogen of verergert hem (whack-a-mole over 100 gecorreleerde features; de held-out char-3-gram volgt niet). Maar de **compositievorm** matchen — de solo-deadpan zeekomkommer dialoog-gedreven maken — bracht béíde vingerafdrukken binnen de Tellegen-spreiding (MFW 0,843→0,755; held-out char3 1,007→0,914): genuine convergentie. De vingerafdruk wordt dus gedomineerd door **vorm** (dialoogdichtheid), niet door woord-tics — bereikbaar in een chirurgie/review-lus, maar ten koste van de vorm-originaliteit (convergeren naar Tellegens dialoog-mal). Detail: `stylometry/RESULTS.md` §7.
