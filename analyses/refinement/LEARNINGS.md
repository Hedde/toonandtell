...
## 11. Model-vergelijking (4.8 / 4.6 / 4.5) — meetbare indruk
Zelfde taak + constraints, alleen schrijfmodel gevarieerd, N=4/model (4.7 niet beschikbaar). Op de held-out char-3-gram: **Opus 4.8 0,906** (binnen echt bereik) < Sonnet 4.6 1,117 < Haiku 4.5 1,105; op MFW zijn 4.8≈4.6, Haiku verst. Dit is de eerste gemeten basis voor de eerder onbewezen "modelbijdrage": 4.8 ligt het dichtst bij de doelstijl op de scherpste vingerafdruk. Voorbehoud: klein (N=4, 2 families, 1 auteur, eigen harness, constraints deels van 4.8-data afgeleid); indruk, geen ranglijst-bewijs.
